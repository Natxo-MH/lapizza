...
<html>
	<head>
		...
		<!-- Compatibilidad para Web App (iOS) Mac -->
		...
		<!-- Compatibilidad para Web App (Android) -->
		<meta name="mobile-web-app-capable" content="yes">
		<meta name="theme-color" content="#a61206">  <!-- Color corporativo empresa (cambiar el content por el color deseado) -->
		<meta name="applcation-name" content="La Pizzeria">
		<link rel="icon" type="image/png" href="<?php echo get_template_directory_uri(); ?>/icono.png" size="201x159">

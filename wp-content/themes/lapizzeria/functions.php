...
function lapizzeria_setup() {
  ...
  add_image_size('nosotros', 437, 291, true);    //para controlar tamaños de imagenes 
...
function lapizzeria_styles() {
  ...
  $apikey = esc_html(get_option('lapizzeria_gmap_apikey')); // con esta variable obtenemos la clave apikey y la llamamos en el wp_register_script siguiente de 'maps'

  // El esc_html es por motivos de seguridad.
...
// Agregar Async y Defer   ---- Código para agregar Google Maps a los proyectos
...
function lapizzeria_especialidades() {
  ...
  // En las dos últimas lineas del array superior ponía 'No Pizzases' creo que es error al cambiar de Especialidades a Pizzas - Lo cambio.
